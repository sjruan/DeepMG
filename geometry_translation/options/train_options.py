...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--update_html_freq', type=int, default=40, help='frequency of saving training results to html')
        ...
        parser.add_argument('--sample_interval', type=int, default=20, help='validation interval')
